...
const WORKSPACE_ITEMS: NavItem[] = [
    ...
    { id: "checklist", label: "Verification Checklist", sublabel: "24-point legal checklist + uploads", icon: ListChecks },
        ...
        <div className="h-full w-full flex bg-slate-50 overflow-hidden">
            ...
            <aside className="shrink-0 w-56 bg-slate-900 text-slate-100 flex flex-col">
                ...
                <div className="flex-1 overflow-y-auto px-2 py-3 space-y-0.5">
                    ...
                    {/* Notes Hub — a workspace tab (id "notes") that opens the
                        parcel-wide notes cockpit in the main content area, like
                        Document Analysis. Keeps the amber sticky-note accent when
                        inactive; adopts the standard active highlight when open. */}
                    <button
                        type="button"
                    ...
                    >
                        <StickyNote
                            className={cn(
                                "w-4 h-4 shrink-0 mt-0.5 transition-colors",
                                activeTab === "notes" ? "text-white" : "text-amber-400 group-hover:text-amber-300",
                            )}
                        />
                        <div className="min-w-0">
                            ...
                            <div
                                className={cn(
                                    "text-[9px] mt-0.5 leading-tight truncate",
                                    activeTab === "notes" ? "text-indigo-100/80" : "text-slate-500 group-hover:text-slate-400",
                                )}
                            >
